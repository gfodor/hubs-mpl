...
class UIRoot extends Component {
  ...
  renderBotMode = () => {
    return (
      <div id="bot-root" style={{ pointerEvents: "auto" }}>
          ...
          <LoadingScreenContainer
            ...
            onLoaded={() => {
              if (!window.botStarted) {
                ...
                // Botomatic does click after it sees these
                //
                const audioInput = document.createElement("input");
                audioInput.setAttribute("type", "file");
                audioInput.setAttribute("accept", "audio/*");
                audioInput.setAttribute("id", "bot-audio-input");

                const dataInput = document.createElement("input");
                dataInput.setAttribute("type", "file");
                dataInput.setAttribute("accept", "application/json");
                dataInput.setAttribute("id", "bot-data-input");

                document.querySelector("#bot-root").appendChild(audioInput);
                document.querySelector("#bot-root").appendChild(dataInput);
  ...
  renderAudioSetupPanel = () => {
    ...
    return (
      <MicSetupModalContainer
        ...
        onChangeMicrophoneMuted={() => this.props.store.update({ preferences: { muteMicOnEntry: true } })}
