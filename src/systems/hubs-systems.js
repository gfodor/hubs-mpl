...
AFRAME.registerSystem("hubs-systems", {
  init() {
    ...
    this.avatarAudioTrackSystem = new AvatarAudioTrackSystem(this.el);
    this.audioSettingsSystem = new AudioSettingsSystem(this.el, this.avatarAudioTrackSystem);
  ...
  tick(t, dt) {
    ...
    this.avatarSystem.tick(t);
    this.avatarAudioTrackSystem.tick(t, dt);
  },
