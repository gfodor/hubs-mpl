...
export class WaypointSystem {
  ...
  moveToUnoccupiableSpawnPoint() {
    ...
    if (waypointComponent) {
      // OSTN, vary waypoint on x, z
      waypointComponent.el.object3D.position.x += -10 + 20 * Math.random();
      waypointComponent.el.object3D.position.z += -10 + 20 * Math.random();
      waypointComponent.el.object3D.matrixNeedsUpdate = true;
      waypointComponent.el.object3D.updateMatrices();
